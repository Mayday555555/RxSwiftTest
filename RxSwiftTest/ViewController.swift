...
class ViewController: UIViewController {
    ...
    private func testRxData() {
        let vcIds = ["ImagePick",  "CXZLabel", "CXZButton", "CXZTextField", "CXZTextView", "CXZOtherView", "CXZGesture", "CXZDatePicker", "CXZPickerView", "CXZCollectionView"]
        tabView.register(UITableViewCell.self, forCellReuseIdentifier: "cell")
        let items = Observable.just([SectionModel(model: "", items: [DataModel(name: "imagePicker"), DataModel(name: "UILabel的使用"), DataModel(name: "UIButton和UISwitch的使用"), DataModel(name: "UITextfield的使用"), DataModel(name: "UITextView的使用"), DataModel(name: "其他控件的使用"), DataModel(name: "Gesture的使用"), DataModel(name: "UIDatePicker的使用"), DataModel(name: "UIPickerVeiw的使用"), DataModel(name: "UICollectionView的使用")])])
